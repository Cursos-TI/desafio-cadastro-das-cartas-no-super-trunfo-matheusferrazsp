...
int main() {
    ...
    float superPoder1 = populacao[0] + kms_quadrados[0] + pib[0] + pontos_turisticos[0] + calculo_pib_1 - densidade_1;
    float superPoder2 = populacao[1] + kms_quadrados[1] + pib[1] + pontos_turisticos[1] + calculo_pib_2 - densidade_2;
